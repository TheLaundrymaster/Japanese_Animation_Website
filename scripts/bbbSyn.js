...
request.onreadystatechange = function getInfo () {
    if (this.readyState === 4) {
        ...
        document.getElementById("bbb").innerHTML =" "+ synopsis;

    }
};
request.open('GET', 'https://kitsu.io/api/edge/anime?filter[text]=blood%20blockade%20battlefront,?page[size]=1&page[size]=2')
