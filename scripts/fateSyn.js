...
request.onreadystatechange = function getInfo () {
    if (this.readyState === 4) {
        ...
        document.getElementById("fate").innerHTML =" "+ synopsis;

    }
};
request.open('GET', 'https://kitsu.io/api/edge/anime?filter[text]=fate/stay%20night%20Unlimited%20blade%20works,?page[size]=1&page[size]=2')
