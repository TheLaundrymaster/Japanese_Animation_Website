...
request.onreadystatechange = function getInfo () {
    if (this.readyState === 4) {
        ...
        document.getElementById("slay").innerHTML =" "+ synopsis;

    }
};
request.open('GET', 'https://kitsu.io/api/edge/anime?filter[text]=Kimetsu%20no%20Yaiba,?page[size]=1&page[size]=2')
