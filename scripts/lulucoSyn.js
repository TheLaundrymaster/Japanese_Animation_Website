...
request.onreadystatechange = function getInfo () {
    if (this.readyState === 4) {
        ...
        document.getElementById("lulu").innerHTML =" "+ synopsis;

    }
};
request.open('GET', 'https://kitsu.io/api/edge/anime?filter[text]=space%20patrol%20luluco,?page[size]=1&page[size]=2')
