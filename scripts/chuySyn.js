...
request.onreadystatechange = function getInfo () {
    if (this.readyState === 4) {
        ...
        document.getElementById("chu").innerHTML =" "+ synopsis;

    }
};
request.open('GET', 'https://kitsu.io/api/edge/anime?filter[text]=love%20chunibyo%20and%20other%20delusions,?page[size]=1&page[size]=2')
